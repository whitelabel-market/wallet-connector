...
class ConnectorWrapperBase extends EventEmitter {
  constructor() {
    super();
    this.loading = false;
  }
...
class ConnectorFactory extends EventEmitter {
  constructor() {
    super();
...
export { Authereum, BinanceChain, ChainIdNotAllowedError, ChainIdNotDesiredError, CoinbaseWallet, Connection, Connectors, Fortmatic, Frame, MetaMask, WalletConnect };
